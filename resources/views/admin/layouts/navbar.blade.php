    ...
    <div class="flex flex-col h-full">
        ...
        <div class="p-6 border-b border-white/20">
            <div class="flex items-center gap-3">
                ...
                <div>
                    <h1 class="text-white font-bold text-xl tracking-wide">Cuma Cafe</h1>
        ...
        <nav class="flex-1 px-4 py-6 space-y-2">
            ...
            <a href="/admin/transactions" class="sidebar-link {{ request()->is('admin/transactions') ? 'active' : '' }}">
        ...
        <div class="p-4 border-t border-white/20">
            ...
            <form method="POST" action="/logout">
                @csrf
                <button class="w-full bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-xl transition-all duration-200 flex items-center justify-center gap-2 font-medium">
